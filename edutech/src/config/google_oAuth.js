...
function installGoogleAuthPlugin(Vue, options) {
  ...
  let GoogleAuthDefaultConfig = { scope: 'profile email https://www.googleapis.com/auth/calendar', discoveryDocs: ['https://www.googleapis.com/discovery/v1/apis/drive/v3/rest'] }
